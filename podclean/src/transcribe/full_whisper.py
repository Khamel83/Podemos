...
def full_transcribe(audio_path: str, model_size: str = "medium", **_):
    ...
    model_file = f"whisper.cpp/models/{model_map.get(model_size,'ggml-medium.en.bin')}"
    out_prefix = tempfile.mktemp(prefix="wsp_full_")
...
if __name__ == "__main__":
    ...
    if os.path.exists(test_audio_path):
        ...
        results = full_transcribe(test_audio_path, model_size="tiny.en") # Use tiny.en for quick test
...
"""
    with open("dummy_full.srt", "w") as f:
        f.write(dummy_srt_content)
    parsed_segments = parse_srt_to_segments("dummy_full.srt")
    print("\nParsed SRT segments (full):")
    for segment in parsed_segments:
        print(segment)
    os.remove("dummy_full.srt") # Clean up dummy file
